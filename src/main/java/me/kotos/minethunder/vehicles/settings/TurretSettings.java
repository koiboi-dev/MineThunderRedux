...
public record TurretSettings(String[] shells, int force, float[] pitchRange, float[] yawRange, boolean remote, int modelID, int gunModelID, float pitchSpeed, float yawSpeed, boolean fixed, int seatModelID, Vector seatPos) {
